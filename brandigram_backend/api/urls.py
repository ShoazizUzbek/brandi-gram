...
urlpatterns = [
    ...
    path('login', MyTokenObtainPairView.as_view(), name='user_registration'),
    path('profile/list', ProfileListView.as_view(), name='profile_list'),
    path('profile/detail/<int:pk>', ProfileDetailView.as_view(), name='profile_list'),
    path('category', CategoryView.as_view(), name='profile_list'),
    path('post/create', PostView.as_view(), name='profile_list'),
